package com.xiaoliu.myweather.db;
...
public class MyWeatherDB {
     ...
     * 单例模式的常见写法
     */
    private static MyWeatherDB coolWeatherDB;
    ...
    public synchronized static MyWeatherDB getInstance(Context context) {
        if (coolWeatherDB == null) {
            return new MyWeatherDB(context);
        }
        return coolWeatherDB;
    }

    /**
     * 从远程服务器保存province数据到本地数据库 数据库的插入操作
     *
     * @param province
     */
    ...
    /**
     * 从远程服务器保存county数据到本地数据库 数据库的插入操作
     *
     * @param county
     */
